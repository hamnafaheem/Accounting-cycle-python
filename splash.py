...
class splashScreen():
    ...
    def splash(self):
        ...
        canvas.create_text(180,160, text='   Submitted To:\nDr Farhan Ahmed Siddiqui', font=("Times 10 bold",18),fill = 'white')
        canvas.create_text(470,145, text='\nBSSE Final Year', font=("Times 10 bold",18),fill = 'white')
        ...
        canvas.create_text(180,330, text='Saim Wafa \nMaheen Tariq \nHamna Faheem Siddiqui', font=("Times 10 bold",16),fill = 'white')
        canvas.create_text(420,330, text='B17158046 \nB20103030 \nB20103028', font=("Times 10 bold",15),fill = 'white')
